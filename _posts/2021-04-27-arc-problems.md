...
考虑一个决策单调性，你发现这个一堆$$\max$$加起来好像是满足四边形不等式的，但是我也不知道满足不满足，所以分治一下就搞定了，如果你想也可以SMAWK![/jy](/img/qqemoji/0.gif)
...
这个怎么做呢?考虑前后缀和优化建图，跑Dinic![/jy](/img/qqemoji/0.gif)
...
ARC083E : 这个问题一眼看上去好像不弱于背包可行性![/jy](/img/qqemoji/0.gif)
...
ARC095E : 只有12![/jy](/img/qqemoji/0.gif)

...
先考虑F1，我们应该以何种顺序完成?这是一个经典结论，我们应该先完成所有$$b$$为正的，再完成所有$$b$$为负的，对于$$b$$为正的显然应该按照$$a$$从小到大的顺序，对于负的则需要考虑一下，邻项交换算一算，可以感觉到应该按照$$a+b$$从大到小的顺序。注意如果这个数是负的，这说明$$a$$的限制不够紧，理论上来讲我们需要把它置为$$0$$，但是实践上可能并不需要。

...
还是重新讲一遍吧!我们设$$f(u)$$表示把$$u$$子树中所有点挂到$$u$$上形成菊花图的最小步数。

那么挂到$$u$$上的最优方案，手画一下应该是先把孙子们变成菊花；然后把每个孙子操作一下挂到$$u$$上，因为操作儿子之后这个点还是没有啥变化。所以$$f(u)$$就是孙子们的$$f$$加起来(把孙子们变成菊花)，再加上孙子的个数(操作孙子们)。

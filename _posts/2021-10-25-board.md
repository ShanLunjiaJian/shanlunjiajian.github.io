...
using map=__gun_pbds::gp_hash_table;
```
...
struct Rand{ unsigned long long x; inline Rand(unsigned long long _x=88172645463325252ll):x(_x){} inline unsigned long long operator (){ return x^=x<<13,x^=x>>7,x^=x<<17; } };
...
struct Rand
{
	...
	inline void jump()
	{
		static const unsigned logn long JUMP[]={0xdf900294d8f554a5,0x170865df4b3201fc};

...
其中$$f=\exp(h)\bmod{z^m},g=\frac{1}{f}\bmod{z^{\frac{m}{2}}}$$。

翻译成刚才我们说的东西，大概是说，$$H$$满足方程$$HG-1=0$$，于是迭代式是$$H\equiv H_0-\frac{H_0G_0-1}{G_0}\equiv 2H_0-G_0H_0^2\pmod{z^n}$$，注意从$$n$$向$$2n$$迭代时，我们计算的$$H$$的次数是$$n$$而不是$$2n$$，$$H$$的长度比$$G$$小一半。这个式子就是倒数的式子，可以在$$6\mathrm{E}(n)$$内计算，如果我们已经保留了$$\mathcal{F}_{\frac{n}{2}}(G_0)$$，则只需要$$5\mathrm{E}(n)$$。这是第一句话。

...
```cpp
inline unsigned long long xorshift64(){ static unsigned long long x=88172645463325252ll; return x^=x<<13,x^=x>>7,x^=x<<17; }

inline unsigned __int128 xorshift128()
{
...
inline unsigned long long xorshift128_ull()
{
	static unsigned long long s[2]={998244353,1004535809};
...
#define xorshift128_lf() ((xorshift128_ull()>>11)*(1.1102230246251565404236316680908203125e-16))

...
考虑dp。问题是我们不知道这些要换到哪，不过没关系，我们可以钦点它换到哪。也就是说，我们钦点在一个地方搅一发，那么就需要把一些换过来，设$$dp(i,j)$$表示前$$i$$个，现在要换到后面$$j$$个的最小代价，$$j$$可能是负数，表示要从后面往前换。转移考虑是否要选以$$i$$结尾的区间，然后这个区间里要留下多少个，显然我们应该留$$a$$最大的那些，剩下的有多少个是前面换进来的，有多少个接下来要从后面换进来。

...
最困难的题是Sparklers，Arranging Tickets和Natural Park。
...
但是这个二分真的没啥用吗?你发现在树上的时候，它求出了$$u\rightsquigarrow v$$上编号最大的点，链上则是求了一个区间$$\max$$。虽然我们不知道它和$$u,v$$有没有边。

考虑在链上，如果它不是$$u,v$$中任何一个，那么我们就把这条链分成了两部分。
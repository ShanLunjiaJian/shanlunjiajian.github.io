...
查了一下，发现正解真的是这个![/jy](/img/qqemoji/0.gif)
...
呃等等，lis个锤子，这是无序的![/jy](/img/qqemoji/0.gif)，我对着lis想半天（

考虑直接贪，同时从大到小扫框和画，找到可以放进来的画中美观度最大的即可。

C. 有趣的家庭菜园3

只有400![/jy](/img/qqemoji/0.gif)

交换相邻![/jy](/img/qqemoji/0.gif)
...
如果是求最大的话已经做完了，因为那样就是直接点B一定不优，于是每个点只会搜一次。这就出到模拟赛里![/jy](/img/qqemoji/0.gif)
...
剩下的问题是拐怎么维护。想了想感觉居然有点困难![/jy](/img/qqemoji/0.gif)
...
呃感觉上可能有，但是没有兴趣了，因为这题6s，线段树分治lct是可以稳过的?没写过。不过就算它过不掉，我们仍然可以自豪地说得到了俩$$\log$$做法（但是没写过不知道正确性![/jy](/img/qqemoji/0.gif)
...
数数题![/jy](/img/qqemoji/0.gif)

打开tag一看，分治，二分图匹配，线段树，这啥啊![/jy](/img/qqemoji/0.gif)
...
$$h,w$$都是5e4，时限5s，这说明啥呢![/jy](/img/qqemoji/0.gif)

$$q$$只有100，这说明啥呢![/jy](/img/qqemoji/0.gif)
...
优先级互不相同，于是我们比较两个数的优先级。于是可以进行一个排序，这相当于对$$a$$排序。但是这要求我们找到每种卡各一张，而这个不是很可行。

然后我们就知道为什么是$$2n$$张而不是$$n$$张卡了。因为$$n$$张你就随手了（

诶随手吗?如果使用归并排序，看起来需要$$250$$次，于是我们要用$$50$$次找到每种卡各一张。这看起来完全不合理。

...
你发现中间的长度实际上是这两个点的两维坐标和的差，于是我们可以拆开两个点的贡献，做完了。
...
等等，这个$$0,\pm 1$$就让人想起来一个题叫Mike and Fish，说的是对欧拉回路上每条边交替定向之后，每个点出入度之差是$$0,\pm 1$$。

考虑我们是不是可以跑一个欧拉回路。你发现一个很有趣的事情，也就是这是可以的/jy

具体怎么做?我们把两棵树都搞出来，按照树上连边，然后每个点如果度数是奇数，就把两棵树上的这个点连起来，然后跑欧拉回路。如果
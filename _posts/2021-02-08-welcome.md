...
如无特殊注明，本blog所有文章使用[CC BY-NC-SA 3.0协议](https://creativecommons.org/licenses/by-nc-sa/3.0/cn/)，简单来说，如果引用、转载、演绎我的文章，那么 BY : 注明我的信息，NC : 不能用于商业用途，SA : 也要使用这一协议。可以以类似这样的方式转载我的文章 : 

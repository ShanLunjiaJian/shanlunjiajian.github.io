...
你发现$$f(F_0)$$是常多项式，所以这是一个......一阶线性微分方程。
...
呃考虑如果只有一个数，我们很容易计算这个东西。如果是两个数，我们需要枚举一个，然后组合数选一选......这是二项卷积啊朋友们!
...
怎么砍这个$$\log$$?考虑这个东西看起来很像$$\exp$$，所以可以求个导试一下能不能递推。

$$
T^\prime(z)=\sum_{i=0}^{b-2}\frac{(i+1)z^i}{(i+1)!}
$$

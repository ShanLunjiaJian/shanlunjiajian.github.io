...
定义一个序列是顺子，当且仅当它看起来像是$$a,a+1,a+2,...$$或者$$a,a-1,a-2,...$$。求有多少个长为$$n$$的序列，不包含长为$$m$$的顺子。$$n,m\leq 5\times 10^6$$。
...
给$$d$$，求在$$[1,d]$$中有序地选$$n$$个数，使得其中可以选出至少$$m$$个不交的对，每一对数值相等的方案数。$$d\leq 10^5,n,m\leq 10^9$$。
...
不过我看懂了一句话 : 当你的ODE太长了，你写了一个$$114514$$项的递推式，那还不如爆力分治法法塔或者对着之前的式子法法塔。